    ...
    <div >
      ...
      <form onSubmit={handleSubmit(onSubmit)} class="flex absolute top-52 left-[40%] ">
        ...
        <div class="grid grid-cols-2 ">
          ...
          <button class=" text-2xl font-semibold bg-gray-300 p-5">SIGN IN</button>
          </div>
          ...
          <div class="p-3">
            ...
            <span class="text-sm text-red-500 ml-8">{errors.number&&"Invalid Number"}</span><br></br>
                ...
                <input type="password" class="border outline-0 border-t-0 border-l-0 border-r-0 ml-12 text-sm mt-4 border-gray-300" placeholder='LAST NAME'
          ...
          <div class="p-6">
            <button class="bg-blue-500 hover:bg-blue-700 text-white  py-2 px-10 rounded-full">Sing Up</button>
